...
export default {
   ...
   methods: {
      ...
      async asyncData() {
         ...
         let monthTideDatas = await this.$axios.$get('https://api.tide736.net/get_tide.php' + '?' + 'pc=' + this.pcNum + '&' + 'hc=' + this.hcNum + '&'+ 'yr=' + timeDatas.yr + '&' + 'mn=' + timeDatas.mn + '&' + 'dy=' + 1 + '&' + 'rg=month');
         ...
         for(let i = 1; i <= calNum; i++) {
            if(calNum == 31 && i ==31){
               monthTideDatas = await this.$axios.$get('https://api.tide736.net/get_tide.php' + '?' + 'pc=' + this.pcNum + '&' + 'hc=' + this.hcNum + '&' + 'yr=' + timeDatas.yr + '&' + 'mn=' + timeDatas.mn + '&' + 'dy=' + 31 + '&' + 'rg=day');
            };
         ...
         this.detailView = 'https://api.tide736.net/tide_image.php' + '?' + 'pc=' + this.pcNum + '&' + 'hc=' + this.hcNum + '&' + 'yr=' + timeDatas.yr + '&' + 'mn=' + timeDatas.mn + '&' + 'dy=';
         // カレンダーをON
