const baseApiUrl = process.env.BASE_API_URL || "https://api.tide736.net/get_tide.php/";
const baseImgiUrl = process.env.BASE_IMG_URL || "https://api.tide736.net/tide_image.php/";
